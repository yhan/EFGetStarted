...
while (true)
{
    ...
    alwaysOnDbContext.BulkUpdate(updateOrders.Values/*, operation => operation.ColumnPrimaryKeyExpression = o => o.Id*/);

    Debug.WriteLine($"[bench] Inserted '{newOrders.Count}' Updated '{updateOrders.Count}': {watch.ElapsedMilliseconds}");
